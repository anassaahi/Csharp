...
namespace CalculatorPD
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                else if (option == 7)
                {
                    ...
                    num = c.sqrt(num);
                    Console.WriteLine("Square root of the number is {0}", num);
                }
                else if (option == 8)
                {
                    double num;
                    ...
                    num = double.Parse(Console.ReadLine());
                    num = c.Exp(num);
                    Console.WriteLine("Exp of the number is {0}", num);
                }
                else if (option == 9)
                {
                    double num;
                    ...
                    num = double.Parse(Console.ReadLine());
                    num = c.Log(num);
                    Console.WriteLine("log of the number is {0}", num);
                }
                else if (option == 9)
                {
                    double num;
                    ...
                    num = double.Parse(Console.ReadLine());
                    num = c.Sin(num);
                    Console.WriteLine("Sin of the number is {0}", num);
                }
                else if (option == 10)
                {
                    double num;
                    ...
                    num = double.Parse(Console.ReadLine());
                    num = c.Cos(num);
                    Console.WriteLine("cos of the number is {0}", num);
                }
                else if (option == 11)
                {
                    double num;
                    ...
                    num = double.Parse(Console.ReadLine());
                    num = c.Tan(num);
                    Console.WriteLine("tan of the number is {0}", num);
                }
                else if (option == 12)
                {
        ...
        static int menu()
        {
            ...
            Console.WriteLine("10.sin");
            Console.WriteLine("11.cos");
            Console.WriteLine("12.tan");
