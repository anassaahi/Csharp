    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true) 
            {
                ...
                {
                    Book b = getInput();
                    Book foundBook = books.Find(book => book.Titles == b.Titles);
                    if(foundBook!=null)
                    {
                ...
                else if(choice == "2")
                {
                    ...
                    if(foundBook!=null)
                    {
                        Console.WriteLine("The Title of the book is : " + foundBook.Titles);
                    }
                    else
                    {
        ...
        {
            Book foundBook = books.Find(book => book.Titles == title);
            return foundBook;
        }
